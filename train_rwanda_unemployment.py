...
X = X.fillna(-1)  # For numerical columns
...
print("\nClassification Report:\n", classification_report(y_test, y_pred_test, target_names=['Employed/Other', 'Unemployed'], zero_division=0))
print("------------------------\n")
